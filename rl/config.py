...
def parse_args(no_env=False, args_override=None):
    ...
    parser.add_argument("--tvf_value_distribution", type=str, default="constant", help="Sampling distribution to use when generating value samples.")
    ...
    parser.add_argument("--tvf_return_mixing", type=int, default=2)
